...
namespace PeliculasAPI
{
    ...
    public class ApplicationDbContext: DbContext 
    {
        ...
        {
            //Agregarle llave a los 2 ( new { x.ActorId, x.PeliculaId })
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            var endgame = new Pelicula()
            {
                ...
                EnCines = true,
                FechaEstreno = new DateTime(2024, 04, 26)
            };
            ...
            var sonic = new Pelicula()
            {
                ...
                EnCines = false,
                FechaEstreno = new DateTime(2025, 02, 28)
            };
            var emma = new Pelicula()
            {
                ...
                Titulo = "Emma",
                EnCines = false,
                FechaEstreno = new DateTime(2025, 02, 21)
            };
            var wonderwoman = new Pelicula()
            {
                ...
                EnCines = false,
                FechaEstreno = new DateTime(2025, 08, 14)
            };
